...
if (args.includes('--help') || args.includes('-h') || args.length === 0) {
  ...
  print('    Claude, Copilot, Cursor, Oz (Warp), GPT, ChatGPT, Gemini, Bard,')
  print('    Codeium, Windsurf, Tabnine, Amazon Q, CodeWhisperer, Aider, Zed,')
  print('    Cody, Devin, Cline, Continue, Llama. Human co-authors are kept.')
  print('')
  print('  Config')
