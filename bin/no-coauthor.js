...
if (args.includes('--help') || args.includes('-h') || args.length === 0) {
  ...
  print('')
  print('  Config')
  print('    .no-coauthorrc.json in ~ can add {"names":[],"emails":[],"domains":[]}')
  print('    A repo-root .no-coauthorrc.json is IGNORED by default (untrusted). Set')
  print('    NO_COAUTHOR_TRUST_REPO=1 to honor it (e.g. in CI for a team-shared config).')
  print('')
